                ...
                <CardContent>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <CheckCircle className="w-5 h-5 mr-2 text-blue-600" /> 100
                      pages/month
                    </li>
                    <li className="flex items-center">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="w-5 h-5 mr-2 text-blue-600" /> 5GB
                      storage
                    </li>
                  </ul>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="w-5 h-5 mr-2 text-blue-600" /> API
                      access
                    </li>
                  </ul>
                </CardContent>
